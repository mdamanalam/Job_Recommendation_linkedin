...
with open(f"D:/Work/Data Science and Analyst Course/ExcelR/Data Science/Project 215/LinkedIn {date.today()}.csv",'a+',encoding='UTF8' ,newline='') as f:
    writer = csv.writer(f)
...
email = "alammdaman2019@gmail.com"
password= "*********"
